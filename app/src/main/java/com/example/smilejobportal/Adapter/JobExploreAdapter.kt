...
class JobExploreAdapter(private val items: List<JobModel>) : RecyclerView.Adapter<JobExploreAdapter.Viewholder>() {

    private lateinit var context: Context

    inner class Viewholder(val binding: ViewholderJobExploreBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Viewholder {
        context = parent.context
        val binding = ViewholderJobExploreBinding.inflate(LayoutInflater.from(parent.context), parent, false)
